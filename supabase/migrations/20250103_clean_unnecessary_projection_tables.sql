-- Drop unnecessary projection tables since only production data changes with scenarios
-- Financial data, debts, investments etc remain the same across scenarios

-- Drop investimentos_projections table
DROP TABLE IF EXISTS investimentos_projections CASCADE;

-- Drop financeiras_projections table
DROP TABLE IF EXISTS financeiras_projections CASCADE;

-- Drop outras_despesas_projections table
DROP TABLE IF EXISTS outras_despesas_projections CASCADE;

-- Drop receitas_financeiras_projections table
DROP TABLE IF EXISTS receitas_financeiras_projections CASCADE;

-- Drop caixa_disponibilidades_projections table
DROP TABLE IF EXISTS caixa_disponibilidades_projections CASCADE;

-- Drop arrendamentos_projections table
DROP TABLE IF EXISTS arrendamentos_projections CASCADE;

-- Drop dividas_imoveis_projections table
DROP TABLE IF EXISTS dividas_imoveis_projections CASCADE;

-- Drop dividas_bancarias_projections table
DROP TABLE IF EXISTS dividas_bancarias_projections CASCADE;

-- Drop dividas_fornecedores_projections table
DROP TABLE IF EXISTS dividas_fornecedores_projections CASCADE;

-- Update create_projection function to only copy production-related data
