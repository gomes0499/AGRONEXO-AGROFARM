-- Fix LTV and MARGEM_EBITDA calculation issues
-- Date: 2025-07-14
-- Description: Ensure LTV uses real property values and MARGEM_EBITDA calculates correctly

-- Update the calculate_rating_metrics_optimized function to ensure correct LTV calculation
