...
export function CommodityPriceTab({
  commodityPrices = [],
}: CommodityPriceTabProps) {
        ...
        <CardContent className="mt-4">
          <div className="bg-amber-50 border-l-4 border-amber-400 p-4 mb-4">
            <p className="text-amber-700 mb-4">
              Não encontramos preços de commodities configurados. Se você acabou
              de criar a tabela, tente recarregar a página para inicializar os
              valores padrão.
            </p>
            <Button
  ...
  const initPriceEditState = (commodityPrice: CommodityPriceType) => {
  ...
  const handleSave = async (commodityPrice: CommodityPriceType) => {
    try {
      setIsLoading((prev) => ({
        ...prev,
      ...
      const updateData: CommodityPriceUpdateType = {
        ...
        currentPrice: safeParseFloat(
          ...
          commodityPrice.currentPrice
        ),
        price2020: safeParseFloat(
          editValues.price2020,
          commodityPrice.price2020 || 0
        ),
        price2021: safeParseFloat(
          editValues.price2021,
          commodityPrice.price2021 || 0
        ),
        price2022: safeParseFloat(
          editValues.price2022,
          commodityPrice.price2022 || 0
        ),
        price2023: safeParseFloat(
          editValues.price2023,
          commodityPrice.price2023 || 0
        ),
        price2024: safeParseFloat(
          editValues.price2024,
          commodityPrice.price2024 || 0
        ),
        price2025: safeParseFloat(
          editValues.price2025,
          commodityPrice.price2025
        ),
        price2026: safeParseFloat(
          editValues.price2026,
          commodityPrice.price2026
        ),
        price2027: safeParseFloat(
          editValues.price2027,
          commodityPrice.price2027
        ),
        price2028: safeParseFloat(
          editValues.price2028,
          commodityPrice.price2028
        ),
        price2029: safeParseFloat(
          editValues.price2029,
          commodityPrice.price2029
        ),
        price2030: safeParseFloat(
          editValues.price2030,
          commodityPrice.price2030 || 0
        ),
      };
      ...
      if (result.data) {
        ...
        commodityPrice.currentPrice =
          updateData.currentPrice || commodityPrice.currentPrice;
        commodityPrice.price2020 =
          updateData.price2020 || commodityPrice.price2020;
        commodityPrice.price2021 =
          updateData.price2021 || commodityPrice.price2021;
        commodityPrice.price2022 =
          updateData.price2022 || commodityPrice.price2022;
        commodityPrice.price2023 =
          updateData.price2023 || commodityPrice.price2023;
        commodityPrice.price2024 =
          updateData.price2024 || commodityPrice.price2024;
        commodityPrice.price2025 =
          updateData.price2025 || commodityPrice.price2025;
        commodityPrice.price2026 =
          updateData.price2026 || commodityPrice.price2026;
        commodityPrice.price2027 =
          updateData.price2027 || commodityPrice.price2027;
        commodityPrice.price2028 =
          updateData.price2028 || commodityPrice.price2028;
        commodityPrice.price2029 =
          updateData.price2029 || commodityPrice.price2029;
        commodityPrice.price2030 =
          updateData.price2030 || commodityPrice.price2030;
      }
      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-primary hover:bg-primary">
            <TableHead className="font-medium text-primary-foreground rounded-tl-md w-[200px]">
              Commodity
            </TableHead>
            ...
            <TableHead className="font-medium text-primary-foreground text-right rounded-tr-md w-[60px]">
              Ações
            </TableHead>
          </TableRow>
        </TableHeader>
          ...
          {prices.map((commodityPrice) => {
            ...
            return (
              <TableRow key={commodityPrice.id}>
                ...
                <TableCell>
                  {allPriceUnits[commodityPrice.commodityType]}
                </TableCell>
                <TableCell>
                  {formatNumber(commodityPrice.currentPrice)}
                </TableCell>
                <TableCell>
                  {commodityPrice.price2020 !== undefined &&
                  commodityPrice.price2020 !== null
                    ? formatNumber(commodityPrice.price2020)
                    : "-"}
                </TableCell>
                <TableCell>
                  {commodityPrice.price2021 !== undefined &&
                  commodityPrice.price2021 !== null
                    ? formatNumber(commodityPrice.price2021)
                    : "-"}
                </TableCell>
                <TableCell>
                  {commodityPrice.price2022 !== undefined &&
                  commodityPrice.price2022 !== null
                    ? formatNumber(commodityPrice.price2022)
                    : "-"}
                </TableCell>
                <TableCell>
                  {commodityPrice.price2023 !== undefined &&
                  commodityPrice.price2023 !== null
                    ? formatNumber(commodityPrice.price2023)
                    : "-"}
                </TableCell>
                <TableCell>
                  {commodityPrice.price2024 !== undefined &&
                  commodityPrice.price2024 !== null
                    ? formatNumber(commodityPrice.price2024)
                    : "-"}
                </TableCell>
                ...
                <TableCell>
                  {commodityPrice.price2030 !== undefined &&
                  commodityPrice.price2030 !== null
                    ? formatNumber(commodityPrice.price2030)
                    : "-"}
                </TableCell>
                <TableCell>
                  <Popover>
                      ...
                      <div className="grid gap-4 w-[800px] max-h-[500px] overflow-y-auto">
                        <div className="space-y-2">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Atualize os preços projetados para os anos
                            seguintes.
                          </p>
                        </div>
                        <div className="grid grid-cols-4 gap-3">
                          <div className="space-y-2">
                            <Label
                              htmlFor={`${commodityPrice.id}-currentPrice`}
                            >
                              Atual (
                              {allPriceUnits[commodityPrice.commodityType]})
                            </Label>
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              value={
                                ...
                                commodityPrice.price2020?.toString() ||
                                "0"
                              }
                              onChange={(e) =>
                                handleInputChange(
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              value={
                                ...
                                commodityPrice.price2021?.toString() ||
                                "0"
                              }
                              onChange={(e) =>
                                handleInputChange(
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              value={
                                ...
                                commodityPrice.price2022?.toString() ||
                                "0"
                              }
                              onChange={(e) =>
                                handleInputChange(
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              value={
                                ...
                                commodityPrice.price2023?.toString() ||
                                "0"
                              }
                              onChange={(e) =>
                                handleInputChange(
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              value={
                                ...
                                commodityPrice.price2024?.toString() ||
                                "0"
                              }
                              onChange={(e) =>
                                handleInputChange(
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              value={
                                ...
                                commodityPrice.price2030?.toString() ||
                                "0"
                              }
                              onChange={(e) =>
                                handleInputChange(
    ...
    <Card className="w-full shadow-sm border-muted/80">
      ...
      <CardContent className="mt-4">
        {commodityPrices.length > 0 &&
          commodityPrices[0].organizacaoId ===
            "1a32121d-b0ff-49b3-8066-4634f1053ca0" &&
          window.location.href.includes("organizacaoId=131db844") && (
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-red-800">
                    Atenção: Dados de outro tenant!
                  </h3>
                  <div className="mt-2 text-sm text-red-700">
                    <p className="font-bold">
                      Você está visualizando e editando preços que pertencem ao
                      tenant "GRUPO TESTE", não ao seu tenant atual "GRUPO SAFRA
                      BOA".
                    </p>
                    <p className="mt-2">
                      Isso significa que suas alterações não vão aparecer no
                      módulo de Arrendamentos. Para corrigir este problema,
                      clique no botão abaixo para inicializar os preços para o
                      seu tenant atual.
                    </p>
                    <div className="mt-3">
                      <Button
                        ...
                        onClick={() => {
                          if (
                            confirm(
                              "Esta ação vai inicializar os preços para o seu tenant atual. Continuar?"
                            )
                          ) {
                            window.location.href =
                              "/dashboard/properties?init_prices=true";
                          }
                        }}
                      >
