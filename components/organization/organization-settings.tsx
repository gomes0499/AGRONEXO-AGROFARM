      ...
      <CardContent className="pt-6 space-y-6">
        <div className="space-y-6">
          ...
          <Alert variant="destructive" className="border-destructive">
            <AlertTitle>Excluir Organização</AlertTitle>
            <AlertDescription>
              Esta ação é permanente e não pode ser desfeita. Todos os dados da
              organização, incluindo propriedades, membros e configurações,
