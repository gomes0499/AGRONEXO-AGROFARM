...
export function PartnershipStep({ form }: PartnershipStepProps) {
  ...
  const totalPercentual = partners.reduce(
    (sum, partner) => sum + (partner.percentual || 0),
    0
  );
  ...
  return (
    <div className="space-y-6">
      <div className="border rounded-lg p-6 space-y-4">
        <h3 className="text-lg font-semibold">Estrutura Societária</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setNewPartner({ ...newPartner, nome: e.target.value })
              }
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                setNewPartner({ ...newPartner, documento: e.target.value })
              }
              placeholder={
                newPartner.tipo_documento === "cpf"
                  ? "000.000.000-00"
                  : "00.000.000/0000-00"
              }
            />
