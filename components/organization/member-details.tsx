            ...
            <TabsContent value="personal" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <p className="text-md">
                    {userData.nome || metadata.name || "Não informado"}
                  </p>
                </div>
                <div className="space-y-2">
                  <p className="text-sm font-medium text-muted-foreground">
                  ...
                  <p className="text-md">
                    {formatDate(
                      metadata.data_nascimento || metadata.dataNascimento
                    )}
                  </p>
                </div>
                <div className="space-y-2">
                  ...
                  <p className="text-md">
                    {metadata.naturalidade || "Não informado"}
                  </p>
                </div>
                <div className="space-y-2">
                  <p className="text-sm font-medium text-muted-foreground">
              ...
              {metadata.estado_civil === "CASADO" ||
              metadata.estado_civil === "CASADA" ||
              metadata.estadoCivil === "Casado" ||
              metadata.estadoCivil === "Casada" ? (
                <>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <p className="text-md">
                        {metadata.nome_conjuge ||
                          metadata.nomeConjuge ||
                          "Não informado"}
                      </p>
                    </div>
                    <div className="space-y-2">
                      ...
                      <p className="text-md">
                        {formatDate(
                          metadata.data_nascimento_conjuge ||
                            metadata.dataNascimentoConjuge
                        )}
                      </p>
                    </div>
                    <div className="space-y-2">
                      ...
                      <p className="text-md">
                        {metadata.cpf_conjuge || metadata.cpfConjuge
                          ? formatCPF(
                              metadata.cpf_conjuge || metadata.cpfConjuge
                            )
                          : "Não informado"}
                      ...
                      <p className="text-md">
                        {metadata.rg_conjuge || metadata.rgConjuge
                          ? `${formatRG(
                              ...
                              metadata.orgao_emissor_conjuge ||
            ...
            <TabsContent value="contact" className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-md">
                    {userData.telefone || metadata.telefone
                      ? formatPhone(userData.telefone || metadata.telefone)
                      : "Não informado"}
                  </p>
                </div>
                <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-md">
                    {metadata.endereco || "Não informado"}
                  </p>
                </div>
                <div className="space-y-2">
                  <p className="text-sm font-medium text-muted-foreground">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-md">
                    {metadata.complemento || "Não informado"}
                  </p>
                </div>
                <div className="space-y-2">
                  <p className="text-sm font-medium text-muted-foreground">
            ...
            <TabsContent value="documents" className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <p className="text-md">
                    {metadata.cpf ? formatCPF(metadata.cpf) : "Não informado"}
                  </p>
                </div>
                <div className="space-y-2">
                  <p className="text-sm font-medium text-muted-foreground">
                  ...
                  <p className="text-md">
                    {metadata.rg
                      ? `${formatRG(metadata.rg)}${
                          metadata.orgao_emissor || metadata.orgaoEmissor
                            ? ` - ${
                                metadata.orgao_emissor || metadata.orgaoEmissor
                              }`
                            : ""
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-md">
                    {metadata.inscricao_produtor_rural ||
                      metadata.inscricaoProdutorRural ||
                      "Não informado"}
                  </p>
                </div>
              </div>
