...
import { deleteSupplier } from "@/lib/actions/financial-actions";
  ...
  return (
    <>
      ...
      <FinancialDeleteAlert
        ...
        description={`Tem certeza que deseja excluir o fornecedor "${supplier.nome}"? Esta ação não pode ser desfeita.`}
