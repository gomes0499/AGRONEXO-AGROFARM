...
import { updateCaixaDisponibilidades } from "@/lib/actions/financial-actions/caixa-disponibilidades";
import { formatGenericCurrency, parseFormattedNumber } from "@/lib/utils/formatters";

interface CaixaDisponibilidadesPopoverEditorProps {
  item: any;
  organizationId: string;
  onUpdate: (updatedItem: any) => void;
}

export function CaixaDisponibilidadesPopoverEditor({
  item,
  organizationId,
  onUpdate,
}: CaixaDisponibilidadesPopoverEditorProps) {
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      const updatedItem = await updateCaixaDisponibilidades(
        item.id,
        {
          nome: item.nome,
