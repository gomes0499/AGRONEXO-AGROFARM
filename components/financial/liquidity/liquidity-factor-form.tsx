...
import {
  LiquidityFactor,
  LiquidityFactorFormValues,
  liquidityFactorFormSchema,
} from "@/schemas/financial/liquidity";
...
import {
  createLiquidityFactor,
  updateLiquidityFactor,
...
export function LiquidityFactorForm({
  ...
  const form = useForm<LiquidityFactorFormValues>({
    ...
    defaultValues: existingFactor
      ? {
          ...existingFactor,
          valores_por_safra:
            typeof existingFactor.valores_por_safra === "string"
  ...
  const handleSubmit = form.handleSubmit(
    async (values: LiquidityFactorFormValues) => {
      try {
        ...
        const dataToSubmit = {
          ...
          valores_por_safra:
            typeof values.valores_por_safra === "object"
  ...
  return (
    <FinancialFormModal
      ...
      title={
        existingFactor ? "Editar Fator de Liquidez" : "Novo Fator de Liquidez"
      }
