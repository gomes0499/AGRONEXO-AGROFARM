...
export const CulturesTab = forwardRef<any, CulturesTabProps>(
  function CulturesTab({ initialCultures, organizationId }, ref) {
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-primary hover:bg-primary">
                  <TableHead className="font-medium text-primary-foreground rounded-tl-md">
                    Nome
                  </TableHead>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  ...
                                  {culture.nome}"? Esta ação não pode ser
                                  desfeita.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
